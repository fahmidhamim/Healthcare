...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    name: 'Fahmid Hossain Hamim',
    image: assets.profile_pic,
    email: 'fh.hamim18@gmail.com',
    phone: '+01721880384',
    address: {
      line1: "Ispahani Colony",
      line2: "Moghbazaar, Dhaka"
    },
    gender: 'Male',
    dob: '2000-07-15'
  })
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className='mt-10'>
        {
          isEdit
          ? <button className='border border-green-600 hover:bg-green-400 px-8 py-2 rounded-full transition-all duration-300' onClick={()=>setIsEdit(false)}>Save information</button>
          : <button className='border border-blue-700 hover:bg-blue-500 hover:text-white px-8 py-2 rounded-full transition-all' onClick={()=>setIsEdit(true)}>Edit</button>
        }
      </div>
